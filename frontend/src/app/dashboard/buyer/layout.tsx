...
import { Gauge, ShoppingBag, ClipboardText, ShieldCheck, BookOpenText } from "@phosphor-icons/react";
import { AuthGate } from "@/components/AuthGate";

const navItems: NavItem[] = [
  { label: "Overview", href: "/dashboard/buyer", icon: Gauge },
